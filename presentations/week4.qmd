...
Now let's take a random sample from a normal distribution as a single experiment. The experiment should have a sample size of 25, a true population mean of 100, and a true standard deviation of 10. Use the `rnorm()` function and assign the simulated data to the variable `single_experiment`.
