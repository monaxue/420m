...
<!--
See 'demo.qmd' for more updated portions of the slides
...
# Manipulating data tables {data-stack-name="Manipulating data tables`"}
...
table_name %>% groub_by(...) %>% mutate(...) %>% summarize(...)
...
table_name %>% mutate(new_column = column_1 - column_2)
