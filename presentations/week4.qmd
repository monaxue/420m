...
<!-- You need to draw this out next time -->
...
ggplot(data, aes(x=Height, fill=Experiment)) + geom_density(color="white") + geom_histogram(aes(x=Means), size=6) + theme_classic() + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_blank(),legend.position = "none")
...
ggplot(data, aes(x=`Means from different experiments`)) + geom_histogram()
...
<!-- Next time you need to draw this out to slow the lecture down -->
::::
:::: {.column .nonincremental}
