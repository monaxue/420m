...
<iframe src="https://wall.sli.do/event/bN8K1hrZToTdRGPHyyPM1U" height=800 width="100%" frameBorder="0" style="min-height: 560px;" allow="clipboard-write" title="Slido"></iframe>
...
**After you create the file, make sure to save the Rmd file and name it `lab3`**
...
## Many small causes -> bell shaped errors
- independent causes
- bell shaped = normally distriubuted = Gaussian
