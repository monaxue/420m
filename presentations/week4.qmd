...
::: notes
This week we will simulate sex differences in height, descriptive and analytic statistics. Use group_by, change colors in the plot, use facet_wrap, and create a summary table. 
...
- Compare the following with the previous version without the group_by(). What's the difference?
...
- For this class, a summary table includes SampleSize, Mean, SD, and SE (standard error).
